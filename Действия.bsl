...
Функция ОтправитьМассивЛюбыхФайлов(Знач Токен, Знач IDЧата, Знач Текст, Знач СоответствиеФайлов, Знач Клавиатура = "") Экспорт
...
Функция ОтправитьКонтакт(Знач Токен, Знач IDЧата, Знач Имя, Знач Фамилия, Знач Телефон, Знач Клавиатура = "") Экспорт
    ...
    _Параметры.Вставить("phone_number"  , Телефон);
    _Параметры.Вставить("reply_markup"  , Клавиатура);
